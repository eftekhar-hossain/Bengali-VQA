...
def main(args):
    ...
    for epoch in range(num_epochs):
        ...
        if val_accuracy > best_val_accuracy:
            ...
            torch.save(model.state_dict(), os.path.join(model_dir, 'mbert.pth'))
            print("Model Saved.")
        else:
    ...
    model.load_state_dict(torch.load(os.path.join(model_dir,'mbert.pth')))
    model.eval()
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='M-DistilBERT-VQA')
